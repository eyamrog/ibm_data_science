...
\begin{frame}{Data Collection}
    ...
    \end{itemize}
    \import{diagrams/}{data_collection}
\end{frame}
...
\begin{frame}{Data Collection -- SpaceX API}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item cores
        \end{itemize}
        \item Jupyter Notebook's GitHub URL: \url{https://github.com/eyamrog/ibm_data_science/blob/main/10_Data_Science_Capstone_Lab1_Collecting_the_Data.ipynb}
    \end{itemize}
\end{frame}

\begin{frame}[t]{Data Sources Diagram}
    \centering
    \begin{tikzpicture}[
        node distance=12mm,
    ...
    {\small Visual summary of probed data sources from the SpaceX v4 API.}
\end{frame}

\begin{frame}{Data Collection -- Scraping}
    %\verb|https://api.spacexdata.com/v4/|
\end{frame}
